...
>
> **다만 «조용히 덮어써진다»는 2026-08-31 부터 사실이 아닙니다.** 배송은 이제 원격 tip 위에
> 얹는 **자손 커밋**이라 여기 푸시된 작업은 부모로 남고, 새로 더한 파일은 살아남으며,
> **납품 파일을 고쳤다면 배송이 그 파일을 이름으로 대며 거부**합니다.
> 무엇이 안전하고 무엇이 아닌지 → [§변경은 어디로 보내나](#변경은-어디로-보내나)
