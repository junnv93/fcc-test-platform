#!/usr/bin/env python3
"""`fcc_test_platform.cross_session_result_selection_evidence_cli` 의 진입점 — 로직은 그쪽이 갖는다.
...
from fcc_test_platform.cross_session_result_selection_evidence_cli import main  # noqa: E402
