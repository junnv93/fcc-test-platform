...
⚠️ 이것은 `scripts/bench_project_result_selection.py` 의 **알맹이**다. `scripts/` 는 패키지가 아니라
...
try:  # noqa: E402 - the runner is importable both as a package and as a script
    ...
    from fcc_test_platform.cross_session_result_selection_evidence_cli import repository_metadata  # noqa: E402
