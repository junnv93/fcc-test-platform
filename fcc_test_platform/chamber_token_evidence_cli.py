...
⚠️ 이것은 `scripts/platform_chamber_token_evidence.py` 의 **알맹이**다. `scripts/` 는 패키지가 아니라
...
def _run_live(args, chamber_ids: list[str]) -> int:
    ...
    from fcc_test_platform.keycloak_chamber_admin import run_lifecycle_live  # noqa: E402
